...
namespace api {
    ...
    void init( ) {
        ...
        void* gameAsm = dlopen( "libil2cpp.so", RTLD_NOLOAD | RTLD_LAZY );
        if ( !gameAsm ) {
            Log( "[ERROR] libil2cpp.so not found" );
            return;
        }
            ...
            while (fgets(line, sizeof(line), fp)) {
                if (strstr(line, "libil2cpp.so")) {
                    ...
                    if (sscanf(line, "%lx-%lx", &start, &end) == 2) {
                        if (module_base == 0) module_base = start;
                        module_size = end - module_base;
                    }
                }
            }
            fclose(fp);
        ...
        get_domain = ( get_domain_t ) dlsym( gameAsm, "il2cpp_domain_get" );
        get_assemblies =
            ( get_assemblies_t ) dlsym( gameAsm, "il2cpp_domain_get_assemblies" );
        assembly_get_image = ( assembly_get_image_t ) dlsym(
            gameAsm, "il2cpp_assembly_get_image" );
        image_get_name =
            ( image_get_name_t ) dlsym( gameAsm, "il2cpp_image_get_name" );

        // class / image enumeration
        image_get_class_count = ( image_get_class_count_t ) dlsym(
            gameAsm, "il2cpp_image_get_class_count" );
        image_get_class =
            ( image_get_class_t ) dlsym( gameAsm, "il2cpp_image_get_class" );

        // class reflection
        class_get_name =
            ( class_get_name_t ) dlsym( gameAsm, "il2cpp_class_get_name" );
        class_get_namespace = ( class_get_namespace_t ) dlsym(
            gameAsm, "il2cpp_class_get_namespace" );
        class_get_flags =
            ( class_get_flags_t ) dlsym( gameAsm, "il2cpp_class_get_flags" );
        class_get_parent =
            ( class_get_parent_t ) dlsym( gameAsm, "il2cpp_class_get_parent" );

        class_is_valuetype = ( class_is_valuetype_t ) dlsym(
            gameAsm, "il2cpp_class_is_valuetype" );
        class_is_interface = ( class_is_interface_t ) dlsym(
            gameAsm, "il2cpp_class_is_interface" );
        class_get_interfaces = ( class_get_interfaces_t ) dlsym(
            gameAsm, "il2cpp_class_get_interfaces" );

        // fields
        class_num_fields =
            ( class_num_fields_t ) dlsym( gameAsm, "il2cpp_class_num_fields" );
        class_get_fields =
            ( class_get_fields_t ) dlsym( gameAsm, "il2cpp_class_get_fields" );
        field_get_name =
            ( field_get_name_t ) dlsym( gameAsm, "il2cpp_field_get_name" );
        field_get_type =
            ( field_get_type_t ) dlsym( gameAsm, "il2cpp_field_get_type" );
        field_get_flags =
            ( field_get_flags_t ) dlsym( gameAsm, "il2cpp_field_get_flags" );
        field_get_offset =
            ( field_get_offset_t ) dlsym( gameAsm, "il2cpp_field_get_offset" );

        // methods
        class_get_methods =
            ( class_get_methods_t ) dlsym( gameAsm, "il2cpp_class_get_methods" );
        method_get_name =
            ( method_get_name_t ) dlsym( gameAsm, "il2cpp_method_get_name" );
        method_get_flags =
            ( method_get_flags_t ) dlsym( gameAsm, "il2cpp_method_get_flags" );
        method_get_param_count = ( method_get_param_count_t ) dlsym(
            gameAsm, "il2cpp_method_get_param_count" );
        method_get_param =
            ( method_get_param_t ) dlsym( gameAsm, "il2cpp_method_get_param" );
        method_get_param_name = ( method_get_param_name_t ) dlsym(
            gameAsm, "il2cpp_method_get_param_name" );
        method_get_return_type = ( method_get_return_type_t ) dlsym(
            gameAsm, "il2cpp_method_get_return_type" );
        method_get_pointer = ( method_get_pointer_t ) dlsym(
            gameAsm, "il2cpp_method_get_pointer" );

        type_get_name =
            ( type_get_name_t ) dlsym( gameAsm, "il2cpp_type_get_name" );
        class_get_type_token = ( class_get_type_token_t ) dlsym(
            gameAsm, "il2cpp_class_get_type_token" );

        thread_attach =
            ( thread_attach_t ) dlsym( gameAsm, "il2cpp_thread_attach" );
        thread_detach =
        ...
        custom_attrs_from_field = ( custom_attrs_from_field_t ) dlsym(
        ...
        field_static_get_value = ( field_static_get_value_t ) dlsym(
            gameAsm, "il2cpp_field_static_get_value" );
        field_get_default_value = ( field_get_default_value_t ) dlsym(
            gameAsm, "il2cpp_field_get_default_value" );

        method_get_token =
            ( method_get_token_t ) dlsym( gameAsm, "il2cpp_method_get_token" );
        method_is_generic =
            ( method_is_generic_t ) dlsym( gameAsm, "il2cpp_method_is_generic" );
        method_is_inflated = ( method_is_inflated_t ) dlsym(
            gameAsm, "il2cpp_method_is_inflated" );

        class_from_name =
            ( class_from_name_t ) dlsym( gameAsm, "il2cpp_class_from_name" );
        class_instance_size = ( class_instance_size_t ) dlsym(
            gameAsm, "il2cpp_class_instance_size" );
        class_value_size =
            ( class_value_size_t ) dlsym( gameAsm, "il2cpp_class_value_size" );

        class_get_properties = ( class_get_properties_t ) dlsym(
            gameAsm, "il2cpp_class_get_properties" );
        class_get_events =
            ( class_get_events_t ) dlsym( gameAsm, "il2cpp_class_get_events" );
        class_get_nested_types = ( class_get_nested_types_t ) dlsym(
            gameAsm, "il2cpp_class_get_nested_types" );

        property_get_name =
            ( property_get_name_t ) dlsym( gameAsm, "il2cpp_property_get_name" );
        property_get_get_method = ( property_get_get_method_t ) dlsym(
            gameAsm, "il2cpp_property_get_get_method" );
        property_get_set_method = ( property_get_set_method_t ) dlsym(
            gameAsm, "il2cpp_property_get_set_method" );
        property_get_flags = ( property_get_flags_t ) dlsym(
            gameAsm, "il2cpp_property_get_flags" );

        event_get_name =
            ( event_get_name_t ) dlsym( gameAsm, "il2cpp_event_get_name" );
        event_get_add_method = ( event_get_add_method_t ) dlsym(
            gameAsm, "il2cpp_event_get_add_method" );
        event_get_remove_method = ( event_get_remove_method_t ) dlsym(
            gameAsm, "il2cpp_event_get_remove_method" );
        event_get_raise_method = ( event_get_raise_method_t ) dlsym(
            gameAsm, "il2cpp_event_get_raise_method" );

        // Runtime invocation suite (for live scene dumper)
        class_get_method_from_name = ( class_get_method_from_name_t ) dlsym(
            gameAsm, "il2cpp_class_get_method_from_name" );
        runtime_invoke =
            ( runtime_invoke_t ) dlsym( gameAsm, "il2cpp_runtime_invoke" );
        type_get_object =
            ( type_get_object_t ) dlsym( gameAsm, "il2cpp_type_get_object" );
        class_get_type =
            ( class_get_type_t ) dlsym( gameAsm, "il2cpp_class_get_type" );
        array_length = ( array_length_t ) dlsym( gameAsm, "il2cpp_array_length" );
        string_length_fn =
            ( string_length_t ) dlsym( gameAsm, "il2cpp_string_length" );
        string_chars = ( string_chars_t ) dlsym( gameAsm, "il2cpp_string_chars" );
        object_unbox = ( object_unbox_t ) dlsym( gameAsm, "il2cpp_object_unbox" );
        field_get_value =
            ( field_get_value_t ) dlsym( gameAsm, "il2cpp_field_get_value" );
        class_get_field_from_name = ( class_get_field_from_name_t ) dlsym(
            gameAsm, "il2cpp_class_get_field_from_name" );

        gc_register_my_thread =
            ( gc_register_my_thread_t ) dlsym( gameAsm, "GC_register_my_thread" );
        gc_unregister_my_thread = ( gc_unregister_my_thread_t ) dlsym(
            gameAsm, "GC_unregister_my_thread" );
        gc_disable = ( gc_disable_t ) dlsym( gameAsm, "il2cpp_gc_disable" );
        gc_enable = ( gc_enable_t ) dlsym( gameAsm, "il2cpp_gc_enable" );
        gc_is_disabled =
            ( gc_is_disabled_t ) dlsym( gameAsm, "il2cpp_gc_is_disabled" );
        gc_disable_boehm = ( gc_disable_boehm_t ) dlsym( gameAsm, "GC_disable" );
        gc_enable_boehm = ( gc_enable_boehm_t ) dlsym( gameAsm, "GC_enable" );
        gc_dont_gc_ptr = ( int * ) dlsym( gameAsm, "GC_dont_gc" );
        ...
        char buf [ 96 ];
        snprintf( buf, sizeof(buf), "[OK] IL2CPP API ready  base=0x%llX  size=0x%zX",
